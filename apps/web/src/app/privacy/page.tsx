  ...
  return (
    <main className="sfc-privacy">
      ...
      <div className="sfc-privacy__body">
        ...
        <Section id="sharing" title="Data Sharing">We do not sell your data. We share data only with payment providers (Safaricom M-Pesa), cloud infrastructure providers (DigitalOcean Frankfurt) under strict data-processing agreements, and law enforcement when legally required.</Section>
