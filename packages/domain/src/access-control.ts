...
const permissionsByRole: Record<AccessRole, AccessPermission[]> = {
  ...
  GLOBAL_FINANCE_ADMIN: ['VIEW_ANALYTICS', 'MANAGE_FINANCE', 'VIEW_BILLING', 'VIEW_TENANT'],
  GLOBAL_ANALYTICS_VIEWER: ['VIEW_ANALYTICS'],
  GLOBAL_MODERATOR_LEAD: ['VIEW_ANALYTICS', 'MODERATE_CONTENT', 'VIEW_TENANT'],
  REGIONAL_ADMIN: ['VIEW_ANALYTICS', 'MODERATE_CONTENT', 'MANAGE_COUNTRY', 'MANAGE_TENANT', 'VIEW_TENANT'],
  CONTINENTAL_ADMIN: ['VIEW_ANALYTICS', 'MODERATE_CONTENT', 'MANAGE_COUNTRY', 'MANAGE_TENANT', 'VIEW_TENANT'],
  COUNTRY_ADMIN: ['VIEW_ANALYTICS', 'MODERATE_CONTENT', 'MANAGE_COUNTRY', 'MANAGE_TENANT', 'VIEW_TENANT'],
  COUNTRY_FINANCE_ADMIN: ['VIEW_ANALYTICS', 'MANAGE_FINANCE', 'VIEW_BILLING', 'VIEW_TENANT'],
  COUNTRY_MODERATOR: ['VIEW_ANALYTICS', 'MODERATE_CONTENT', 'VIEW_TENANT'],
